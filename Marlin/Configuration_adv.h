...
#define HOMING_BUMP_DIVISOR { 10, 10, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)  rock_20220624
...
// @section lcd
  ...
  //#define MANUAL_FEEDRATE { 20*60, 20*60, 4*60, 60 * 21 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  // #define EVENT_GCODE_SD_ABORT "G28 X220 Y220  F3000" "\n" "M84" // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH        0  // (mm) The length of filament for a complete unload.  rock_20220624
